...
//slice and splice
const arey=arr.slice(1,3)//donot iclude 3
// console.log(arey)
const arey2=arr2.splice(1,3)//include 3 and remove the values from original array like in this element from 2 to 3 is removed from original array
// console.log(arey2)
// const arr4=arr1.
// console.log(arr)
// console.log(arr2)
